...
<html lang="en">
  ...
  <div class="container ">
        ...
        <span class="navbar-brand mb-0 h1">Kawal Corona</span>
        <span class="navbar-text">
        <a class="btn_2 d-none d-lg-block" >Resawan Hungkul</a>
    </span>
        </nav>
          ...
          <div class="container">
           <div class="row align-items-center">
            ...
            <div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
             ...
             <br><a href=""><img src="{{asset('img/happy-ipM.png')}}" width="50" height="50" ></a><br><br>
